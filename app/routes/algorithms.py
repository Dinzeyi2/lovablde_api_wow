...
@router.post("/routing/tsp_genetic")
...
@router.post("/string/kmp")
async def kmp_endpoint(input_data: KMPInput, request: Request):
    """KMP String Matching - Fast pattern search in text"""
    try:
        result = execute_kmp(input_data)
        return result
    except Exception as e:
        raise HTTPException(status_code=400, detail=str(e))
